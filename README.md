...
| ImproperUI | ![Modrinth Downloads](https://img.shields.io/modrinth/dt/improperui?label=Modrinth&color=04b54b) ![CurseForge Downloads](https://img.shields.io/curseforge/dt/1418749?label=CurseForge&color=orange) ![GitHub Downloads](https://img.shields.io/github/downloads/itzispyder/improperui/total?label=GitHub&color=blue) |
| `...` | `...` |
